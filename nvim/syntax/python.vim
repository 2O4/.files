"
" Custom version of python-syntax https://github.com/vim-python/python-syntax
" changes: different highlight for class's names
"
...
if v:version >= 508 || !exists('did_python_syn_inits')
    ...
    HiLink pythonClassCall        Function
...
hi link pythonFunctionParam Boolean
